...
const getBalance = async () => {
  ...
  fetch(
    ...
    .then((result) => {
      ...
      balance = data;
      console.log(balance);
      document.getElementById("acbalance").innerText = data;
    })
...
// const range = prompt("Enter the range to play");
// if (balance > 0) {
  var STARTING_BANKROLL = parseInt(prompt("Enter the starting bankroll"));
// }
if (STARTING_BANKROLL > balance) {
  alert("Starting bankroll cannot be greater than account balance");
  // Handle the error condition here
} else {
  alert("Starting bankroll: " + STARTING_BANKROLL);
  console.log(balance);
  console.log(+balance-+STARTING_BANKROLL);
  updateBalance(+(balance - STARTING_BANKROLL));
}
...
function new_round() {
  ...
  percentcomplete =
    ...
    getmycurrenttime +
    "] " +
    "<font color='orange'>Status Progress</font>: " +
    tperc +
    "%<br>";
  var mydealris =
    "[" +
    getmycurrenttime +
    "] " +
    "<font color='red'>Dealer is</font>: " +
    mycurrentdealeris +
    "<br>";
  var winningstringtotal =
    "<font color='green'>Cash Amount</font>: $" +
    players[0].bankroll +
    " (+: " +
    mycurrentamount +
    ")";
  var numberofroundsstring =
    percentcomplete +
    mydealris +
    "[" +
    getmycurrenttime +
...
function handle_end_of_round() {
  ...
  if (allocations[0] > 5) {
    ...
    var winningstring =
      ...
      "<font color='blue'>Game</font>: " +
      mynumberofgames +
      ", <font color='blue'>You win this round</font>: " +
      mynumberofroundswon +
      "/" +
      mynumberofrounds;
...
function the_bet_function(player_index, bet_amount) {
  ...
  for (var reds = 0; reds < fives; reds++) {
    if (playerrandompokerchips < 20) {
      ...
      document.getElementById(
        "playerchipred" + playerrandompokerchips
      ).style.marginLeft = playerrandomleft + "px";
      document.getElementById(
        "playerchipred" + playerrandompokerchips
      ).style.marginTop = playergraphicpot + "px";
      document.getElementById(
        "playerchipred" + playerrandompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < tens; blues++) {
    if (playerrandompokerchips < 20) {
      playergraphicpot = playerrandomtop + playerpotposition;
      document.getElementById(
        "playerchipblue" + playerrandompokerchips
      ).style.marginLeft = playerrandomleft + "px";
      document.getElementById(
        "playerchipblue" + playerrandompokerchips
      ).style.marginTop = playergraphicpot + "px";
  ...
  for (var greens = 0; greens < twentyfives; greens++) {
    if (playerrandompokerchips < 20) {
      playergraphicpot = playerrandomtop + playerpotposition;
      document.getElementById(
        "playerchipgreen" + playerrandompokerchips
      ).style.marginLeft = playerrandomleft + "px";
      document.getElementById(
        "playerchipgreen" + playerrandompokerchips
      ).style.marginTop = playergraphicpot + "px";
  ...
  for (var blacks = 0; blacks < hundreds; blacks++) {
    if (playerrandompokerchips < 20) {
      playergraphicpot = playerrandomtop + playerpotposition;
      document.getElementById(
        "playerchipblack" + playerrandompokerchips
      ).style.marginLeft = playerrandomleft + "px";
      document.getElementById(
        "playerchipblack" + playerrandompokerchips
      ).style.marginTop = playergraphicpot + "px";
  ...
  for (var golds = 0; golds < thousands; golds++) {
    if (playerrandompokerchips < 20) {
      playergraphicpot = playerrandomtop + playerpotposition;
      document.getElementById(
        "playerchipgold" + playerrandompokerchips
      ).style.marginLeft = playerrandomleft + "px";
      document.getElementById(
        "playerchipgold" + playerrandompokerchips
      ).style.marginTop = playergraphicpot + "px";
  ...
  for (var reds = 0; reds < bot1fives; reds++) {
    if (bot1randompokerchips < 20) {
      ...
      document.getElementById(
        "bot1chipred" + bot1randompokerchips
      ).style.marginLeft = bot1randomleft + "px";
      document.getElementById(
        "bot1chipred" + bot1randompokerchips
      ).style.marginTop = bot1graphicpot + "px";
      document.getElementById(
        "bot1chipred" + bot1randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot1tens; blues++) {
    if (bot1randompokerchips < 20) {
      bot1graphicpot = bot1randomtop + bot1potposition;
      document.getElementById(
        "bot1chipblue" + bot1randompokerchips
      ).style.marginLeft = bot1randomleft + "px";
      document.getElementById(
        "bot1chipblue" + bot1randompokerchips
      ).style.marginTop = bot1graphicpot + "px";
  ...
  for (var greens = 0; greens < bot1twentyfives; greens++) {
    if (bot1randompokerchips < 20) {
      bot1graphicpot = bot1randomtop + bot1potposition;
      document.getElementById(
        "bot1chipgreen" + bot1randompokerchips
      ).style.marginLeft = bot1randomleft + "px";
      document.getElementById(
        "bot1chipgreen" + bot1randompokerchips
      ).style.marginTop = bot1graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot1hundreds; blacks++) {
    if (bot1randompokerchips < 20) {
      bot1graphicpot = bot1randomtop + bot1potposition;
      document.getElementById(
        "bot1chipblack" + bot1randompokerchips
      ).style.marginLeft = bot1randomleft + "px";
      document.getElementById(
        "bot1chipblack" + bot1randompokerchips
      ).style.marginTop = bot1graphicpot + "px";
  ...
  for (var golds = 0; golds < bot1thousands; golds++) {
    if (bot1randompokerchips < 20) {
      bot1graphicpot = bot1randomtop + bot1potposition;
      document.getElementById(
        "bot1chipgold" + bot1randompokerchips
      ).style.marginLeft = bot1randomleft + "px";
      document.getElementById(
        "bot1chipgold" + bot1randompokerchips
      ).style.marginTop = bot1graphicpot + "px";
  ...
  for (var reds = 0; reds < bot2fives; reds++) {
    if (bot2randompokerchips < 20) {
      ...
      document.getElementById(
        "bot2chipred" + bot2randompokerchips
      ).style.marginLeft = bot2randomleft + "px";
      document.getElementById(
        "bot2chipred" + bot2randompokerchips
      ).style.marginTop = bot2graphicpot + "px";
      document.getElementById(
        "bot2chipred" + bot2randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot2tens; blues++) {
    if (bot2randompokerchips < 20) {
      bot2graphicpot = bot2randomtop + bot2potposition;
      document.getElementById(
        "bot2chipblue" + bot2randompokerchips
      ).style.marginLeft = bot2randomleft + "px";
      document.getElementById(
        "bot2chipblue" + bot2randompokerchips
      ).style.marginTop = bot2graphicpot + "px";
  ...
  for (var greens = 0; greens < bot2twentyfives; greens++) {
    if (bot2randompokerchips < 20) {
      bot2graphicpot = bot2randomtop + bot2potposition;
      document.getElementById(
        "bot2chipgreen" + bot2randompokerchips
      ).style.marginLeft = bot2randomleft + "px";
      document.getElementById(
        "bot2chipgreen" + bot2randompokerchips
      ).style.marginTop = bot2graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot2hundreds; blacks++) {
    if (bot2randompokerchips < 20) {
      bot2graphicpot = bot2randomtop + bot2potposition;
      document.getElementById(
        "bot2chipblack" + bot2randompokerchips
      ).style.marginLeft = bot2randomleft + "px";
      document.getElementById(
        "bot2chipblack" + bot2randompokerchips
      ).style.marginTop = bot2graphicpot + "px";
  ...
  for (var golds = 0; golds < bot2thousands; golds++) {
    if (bot2randompokerchips < 20) {
      bot2graphicpot = bot2randomtop + bot2potposition;
      document.getElementById(
        "bot2chipgold" + bot2randompokerchips
      ).style.marginLeft = bot2randomleft + "px";
      document.getElementById(
        "bot2chipgold" + bot2randompokerchips
      ).style.marginTop = bot2graphicpot + "px";
  ...
  for (var reds = 0; reds < bot3fives; reds++) {
    if (bot3randompokerchips < 20) {
      ...
      document.getElementById(
        "bot3chipred" + bot3randompokerchips
      ).style.marginLeft = bot3randomleft + "px";
      document.getElementById(
        "bot3chipred" + bot3randompokerchips
      ).style.marginTop = bot3graphicpot + "px";
      document.getElementById(
        "bot3chipred" + bot3randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot3tens; blues++) {
    if (bot3randompokerchips < 20) {
      bot3graphicpot = bot3randomtop + bot3potposition;
      document.getElementById(
        "bot3chipblue" + bot3randompokerchips
      ).style.marginLeft = bot3randomleft + "px";
      document.getElementById(
        "bot3chipblue" + bot3randompokerchips
      ).style.marginTop = bot3graphicpot + "px";
  ...
  for (var greens = 0; greens < bot3twentyfives; greens++) {
    if (bot3randompokerchips < 20) {
      bot3graphicpot = bot3randomtop + bot3potposition;
      document.getElementById(
        "bot3chipgreen" + bot3randompokerchips
      ).style.marginLeft = bot3randomleft + "px";
      document.getElementById(
        "bot3chipgreen" + bot3randompokerchips
      ).style.marginTop = bot3graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot3hundreds; blacks++) {
    if (bot3randompokerchips < 20) {
      bot3graphicpot = bot3randomtop + bot3potposition;
      document.getElementById(
        "bot3chipblack" + bot3randompokerchips
      ).style.marginLeft = bot3randomleft + "px";
      document.getElementById(
        "bot3chipblack" + bot3randompokerchips
      ).style.marginTop = bot3graphicpot + "px";
  ...
  for (var golds = 0; golds < bot3thousands; golds++) {
    if (bot3randompokerchips < 20) {
      bot3graphicpot = bot3randomtop + bot3potposition;
      document.getElementById(
        "bot3chipgold" + bot3randompokerchips
      ).style.marginLeft = bot3randomleft + "px";
      document.getElementById(
        "bot3chipgold" + bot3randompokerchips
      ).style.marginTop = bot3graphicpot + "px";
  ...
  for (var reds = 0; reds < bot4fives; reds++) {
    if (bot4randompokerchips < 20) {
      ...
      document.getElementById(
        "bot4chipred" + bot4randompokerchips
      ).style.marginLeft = bot4randomleft + "px";
      document.getElementById(
        "bot4chipred" + bot4randompokerchips
      ).style.marginTop = bot4graphicpot + "px";
      document.getElementById(
        "bot4chipred" + bot4randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot4tens; blues++) {
    if (bot4randompokerchips < 20) {
      bot4graphicpot = bot4randomtop + bot4potposition;
      document.getElementById(
        "bot4chipblue" + bot4randompokerchips
      ).style.marginLeft = bot4randomleft + "px";
      document.getElementById(
        "bot4chipblue" + bot4randompokerchips
      ).style.marginTop = bot4graphicpot + "px";
  ...
  for (var greens = 0; greens < bot4twentyfives; greens++) {
    if (bot4randompokerchips < 20) {
      bot4graphicpot = bot4randomtop + bot4potposition;
      document.getElementById(
        "bot4chipgreen" + bot4randompokerchips
      ).style.marginLeft = bot4randomleft + "px";
      document.getElementById(
        "bot4chipgreen" + bot4randompokerchips
      ).style.marginTop = bot4graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot4hundreds; blacks++) {
    if (bot4randompokerchips < 20) {
      bot4graphicpot = bot4randomtop + bot4potposition;
      document.getElementById(
        "bot4chipblack" + bot4randompokerchips
      ).style.marginLeft = bot4randomleft + "px";
      document.getElementById(
        "bot4chipblack" + bot4randompokerchips
      ).style.marginTop = bot4graphicpot + "px";
  ...
  for (var golds = 0; golds < bot4thousands; golds++) {
    if (bot4randompokerchips < 20) {
      bot4graphicpot = bot4randomtop + bot4potposition;
      document.getElementById(
        "bot4chipgold" + bot4randompokerchips
      ).style.marginLeft = bot4randomleft + "px";
      document.getElementById(
        "bot4chipgold" + bot4randompokerchips
      ).style.marginTop = bot4graphicpot + "px";
  ...
  for (var reds = 0; reds < bot5fives; reds++) {
    if (bot5randompokerchips < 20) {
      ...
      document.getElementById(
        "bot5chipred" + bot5randompokerchips
      ).style.marginLeft = bot5randomleft + "px";
      document.getElementById(
        "bot5chipred" + bot5randompokerchips
      ).style.marginTop = bot5graphicpot + "px";
      document.getElementById(
        "bot5chipred" + bot5randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot5tens; blues++) {
    if (bot5randompokerchips < 20) {
      bot5graphicpot = bot5randomtop + bot5potposition;
      document.getElementById(
        "bot5chipblue" + bot5randompokerchips
      ).style.marginLeft = bot5randomleft + "px";
      document.getElementById(
        "bot5chipblue" + bot5randompokerchips
      ).style.marginTop = bot5graphicpot + "px";
  ...
  for (var greens = 0; greens < bot5twentyfives; greens++) {
    if (bot5randompokerchips < 20) {
      bot5graphicpot = bot5randomtop + bot5potposition;
      document.getElementById(
        "bot5chipgreen" + bot5randompokerchips
      ).style.marginLeft = bot5randomleft + "px";
      document.getElementById(
        "bot5chipgreen" + bot5randompokerchips
      ).style.marginTop = bot5graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot5hundreds; blacks++) {
    if (bot5randompokerchips < 20) {
      bot5graphicpot = bot5randomtop + bot5potposition;
      document.getElementById(
        "bot5chipblack" + bot5randompokerchips
      ).style.marginLeft = bot5randomleft + "px";
      document.getElementById(
        "bot5chipblack" + bot5randompokerchips
      ).style.marginTop = bot5graphicpot + "px";
  ...
  for (var golds = 0; golds < bot5thousands; golds++) {
    if (bot5randompokerchips < 20) {
      bot5graphicpot = bot5randomtop + bot5potposition;
      document.getElementById(
        "bot5chipgold" + bot5randompokerchips
      ).style.marginLeft = bot5randomleft + "px";
      document.getElementById(
        "bot5chipgold" + bot5randompokerchips
      ).style.marginTop = bot5graphicpot + "px";
  ...
  for (var reds = 0; reds < bot6fives; reds++) {
    if (bot6randompokerchips < 20) {
      ...
      document.getElementById(
        "bot6chipred" + bot6randompokerchips
      ).style.marginLeft = bot6randomleft + "px";
      document.getElementById(
        "bot6chipred" + bot6randompokerchips
      ).style.marginTop = bot6graphicpot + "px";
      document.getElementById(
        "bot6chipred" + bot6randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot6tens; blues++) {
    if (bot6randompokerchips < 20) {
      bot6graphicpot = bot6randomtop + bot6potposition;
      document.getElementById(
        "bot6chipblue" + bot6randompokerchips
      ).style.marginLeft = bot6randomleft + "px";
      document.getElementById(
        "bot6chipblue" + bot6randompokerchips
      ).style.marginTop = bot6graphicpot + "px";
  ...
  for (var greens = 0; greens < bot6twentyfives; greens++) {
    if (bot6randompokerchips < 20) {
      bot6graphicpot = bot6randomtop + bot6potposition;
      document.getElementById(
        "bot6chipgreen" + bot6randompokerchips
      ).style.marginLeft = bot6randomleft + "px";
      document.getElementById(
        "bot6chipgreen" + bot6randompokerchips
      ).style.marginTop = bot6graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot6hundreds; blacks++) {
    if (bot6randompokerchips < 20) {
      bot6graphicpot = bot6randomtop + bot6potposition;
      document.getElementById(
        "bot6chipblack" + bot6randompokerchips
      ).style.marginLeft = bot6randomleft + "px";
      document.getElementById(
        "bot6chipblack" + bot6randompokerchips
      ).style.marginTop = bot6graphicpot + "px";
  ...
  for (var golds = 0; golds < bot6thousands; golds++) {
    if (bot6randompokerchips < 20) {
      bot6graphicpot = bot6randomtop + bot6potposition;
      document.getElementById(
        "bot6chipgold" + bot6randompokerchips
      ).style.marginLeft = bot6randomleft + "px";
      document.getElementById(
        "bot6chipgold" + bot6randompokerchips
      ).style.marginTop = bot6graphicpot + "px";
  ...
  for (var reds = 0; reds < bot7fives; reds++) {
    if (bot7randompokerchips < 20) {
      ...
      document.getElementById(
        "bot7chipred" + bot7randompokerchips
      ).style.marginLeft = bot7randomleft + "px";
      document.getElementById(
        "bot7chipred" + bot7randompokerchips
      ).style.marginTop = bot7graphicpot + "px";
      document.getElementById(
        "bot7chipred" + bot7randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot7tens; blues++) {
    if (bot7randompokerchips < 20) {
      bot7graphicpot = bot7randomtop + bot7potposition;
      document.getElementById(
        "bot7chipblue" + bot7randompokerchips
      ).style.marginLeft = bot7randomleft + "px";
      document.getElementById(
        "bot7chipblue" + bot7randompokerchips
      ).style.marginTop = bot7graphicpot + "px";
  ...
  for (var greens = 0; greens < bot7twentyfives; greens++) {
    if (bot7randompokerchips < 20) {
      bot7graphicpot = bot7randomtop + bot7potposition;
      document.getElementById(
        "bot7chipgreen" + bot7randompokerchips
      ).style.marginLeft = bot7randomleft + "px";
      document.getElementById(
        "bot7chipgreen" + bot7randompokerchips
      ).style.marginTop = bot7graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot7hundreds; blacks++) {
    if (bot7randompokerchips < 20) {
      bot7graphicpot = bot7randomtop + bot7potposition;
      document.getElementById(
        "bot7chipblack" + bot7randompokerchips
      ).style.marginLeft = bot7randomleft + "px";
      document.getElementById(
        "bot7chipblack" + bot7randompokerchips
      ).style.marginTop = bot7graphicpot + "px";
  ...
  for (var golds = 0; golds < bot7thousands; golds++) {
    if (bot7randompokerchips < 20) {
      bot7graphicpot = bot7randomtop + bot7potposition;
      document.getElementById(
        "bot7chipgold" + bot7randompokerchips
      ).style.marginLeft = bot7randomleft + "px";
      document.getElementById(
        "bot7chipgold" + bot7randompokerchips
      ).style.marginTop = bot7graphicpot + "px";
  ...
  for (var reds = 0; reds < bot8fives; reds++) {
    if (bot8randompokerchips < 20) {
      ...
      document.getElementById(
        "bot8chipred" + bot8randompokerchips
      ).style.marginLeft = bot8randomleft + "px";
      document.getElementById(
        "bot8chipred" + bot8randompokerchips
      ).style.marginTop = bot8graphicpot + "px";
      document.getElementById(
        "bot8chipred" + bot8randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < bot8tens; blues++) {
    if (bot8randompokerchips < 20) {
      bot8graphicpot = bot8randomtop + bot8potposition;
      document.getElementById(
        "bot8chipblue" + bot8randompokerchips
      ).style.marginLeft = bot8randomleft + "px";
      document.getElementById(
        "bot8chipblue" + bot8randompokerchips
      ).style.marginTop = bot8graphicpot + "px";
  ...
  for (var greens = 0; greens < bot8twentyfives; greens++) {
    if (bot8randompokerchips < 20) {
      bot8graphicpot = bot8randomtop + bot8potposition;
      document.getElementById(
        "bot8chipgreen" + bot8randompokerchips
      ).style.marginLeft = bot8randomleft + "px";
      document.getElementById(
        "bot8chipgreen" + bot8randompokerchips
      ).style.marginTop = bot8graphicpot + "px";
  ...
  for (var blacks = 0; blacks < bot8hundreds; blacks++) {
    if (bot8randompokerchips < 20) {
      bot8graphicpot = bot8randomtop + bot8potposition;
      document.getElementById(
        "bot8chipblack" + bot8randompokerchips
      ).style.marginLeft = bot8randomleft + "px";
      document.getElementById(
        "bot8chipblack" + bot8randompokerchips
      ).style.marginTop = bot8graphicpot + "px";
  ...
  for (var golds = 0; golds < bot8thousands; golds++) {
    if (bot8randompokerchips < 20) {
      bot8graphicpot = bot8randomtop + bot8potposition;
      document.getElementById(
        "bot8chipgold" + bot8randompokerchips
      ).style.marginLeft = bot8randomleft + "px";
      document.getElementById(
        "bot8chipgold" + bot8randompokerchips
      ).style.marginTop = bot8graphicpot + "px";
...
function bet_from_bot(x) {
  ...
  if (b >= players[x].bankroll) {
    ...
    if (x == 9) document.getElementById("bbet9").style.background = "black";
  } else if (b == n) {
    // CALL
    ...
    if (x == 9) document.getElementById("bbet9").style.background = "lawngreen";
  } else if (b > n) {
...
function write_player(n, hilite, show_cards) {
  ...
  if (players[n].status == "FOLD") {
    ...
    if (n == 0) document.getElementById("mybet").style.background = "red";
    if (n == 1) {
      var avatarname = "avatar" + botarray[0];
      var avatarimage = "avatar/_bot" + botarray[0] + "_call.png";
      document.getElementById(avatarname).src = avatarimage;
    ...
    if (n == 9) document.getElementById("bbet9").style.background = "red";
...
function get_pot_size() {
  ...
  for (var reds = 0; reds < fives; reds++) {
    if (randompokerchips < 20) {
      ...
      document.getElementById(
        "mypokerchipred" + randompokerchips
      ).style.marginLeft = randomleft + "px";
      document.getElementById(
        "mypokerchipred" + randompokerchips
      ).style.marginTop = graphicpot + "px";
      document.getElementById(
        "mypokerchipred" + randompokerchips
      ).style.display = "block";
      document.getElementById(
  ...
  for (var blues = 0; blues < tens; blues++) {
    if (randompokerchips < 20) {
      graphicpot = randomtop + potposition;
      document.getElementById(
        "mypokerchipblue" + randompokerchips
      ).style.marginLeft = randomleft + "px";
      document.getElementById(
        "mypokerchipblue" + randompokerchips
      ).style.marginTop = graphicpot + "px";
  ...
  for (var greens = 0; greens < twentyfives; greens++) {
    if (randompokerchips < 20) {
      graphicpot = randomtop + potposition;
      document.getElementById(
        "mypokerchipgreen" + randompokerchips
      ).style.marginLeft = randomleft + "px";
      document.getElementById(
        "mypokerchipgreen" + randompokerchips
      ).style.marginTop = graphicpot + "px";
  ...
  for (var blacks = 0; blacks < hundreds; blacks++) {
    if (randompokerchips < 20) {
      graphicpot = randomtop + potposition;
      document.getElementById(
        "mypokerchipblack" + randompokerchips
      ).style.marginLeft = randomleft + "px";
      document.getElementById(
        "mypokerchipblack" + randompokerchips
      ).style.marginTop = graphicpot + "px";
  ...
  for (var golds = 0; golds < thousands; golds++) {
    if (randompokerchips < 20) {
      graphicpot = randomtop + potposition;
      document.getElementById(
        "mypokerchipgold" + randompokerchips
      ).style.marginLeft = randomleft + "px";
      document.getElementById(
        "mypokerchipgold" + randompokerchips
      ).style.marginTop = graphicpot + "px";
